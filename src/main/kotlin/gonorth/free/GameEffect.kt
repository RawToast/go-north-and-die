...
sealed class GameEffect {
    data class Describe(val text: String): GameEffect()
    data class KillPlayer(val text: String) : GameEffect()
    data class TeleportPlayer(val locationUUID: String, val text: String) : GameEffect()
    data class OneWayLink(val link: LinkDetails, val text: String) : GameEffect()
    data class TwoWayLink(val link: LinkDetails, val returnLink: LinkDetails, val text: String) : GameEffect()
    data class IncreaseHunger(val amount: Int) : GameEffect()
    data class ReduceHunger(val amount: Int) : GameEffect()

    data class Destroy(val itemName: String) : GameEffect()
    data class RemoveItem(val itemName: String) : GameEffect()
//
//
